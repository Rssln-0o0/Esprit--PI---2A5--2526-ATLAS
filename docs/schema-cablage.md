...
## Elements attendus avant publication

Ajouter au dossier `docs/` :

- une image annotee du montage ;
- un schema Fritzing, KiCad ou equivalent si disponible ;
- une photo claire du prototype final ;
- les ports serie utilises pendant la demonstration.
